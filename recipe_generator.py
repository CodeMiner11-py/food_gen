...
The third part is the ingredients needed, separated by comma symbols (,) (no spaces between comma symbols). Do not include ingredient numbers. Extra ingredients should fit within the budget. This should not include the ingredients at home. Make sure you use measurements.
...
Tip: Try not to include 'Quick' or 'Hearty' or 'Speedy' or any other adjective as the first word in the title.
...
The second part is a friendly description of the dish, along with the time it takes and how many it serves.
The third part is the ingredients needed, separated by comma symbols (,) (no spaces between and symbols). Do not include ingredient numbers. Make sure you use measurements. DO NOT INCLUDE the ingredients already at home.
The fourth part is the procedures to make the dish, separated by comma symbols (,) (no spaces between and symbols). Do not include procedure numbers.
